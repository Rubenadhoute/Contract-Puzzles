...
To modify the tests to make the test case pass without modifying the smart contract (and leaving the `isWon` assertion in place).

### Important Notice

Every test file related to each challenge is filled with my solution.
